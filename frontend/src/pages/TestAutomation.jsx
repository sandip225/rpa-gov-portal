      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-800">Torrent Power Automation Test</h1>
              <p className="text-gray-600 text-lg">Direct testing without login/registration</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 border border-gray-200">
          ...
          <div className="flex items-center justify-between pt-6 border-t border-gray-200">
            <div className="text-sm text-gray-600">
              <p>🔧 This is a test page to directly test automation without login</p>
              <p>📝 Fill the form above and click the automation button</p>
            </div>
