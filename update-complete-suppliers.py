#!/usr/bin/env python3
"""
Complete Gujarat Suppliers Update with ALL Official Portal URLs
Based on comprehensive supplier data with name change and address change URLs
"""
import json
import os
...
COMPLETE_SUPPLIERS_DATA = {
    "gas": [
        {
            ...
            "office_url": "https://www.gujaratgas.com/contact-us/offices/",
            "api_available": False,
        ...
        },
        {
            ...
            "offline_form_url": "Local Sabarmati office",
            "api_available": False,
            "online_available": False,
            "automation_type": "manual_only",
        ...
        },
        {
            ...
            "offline_form_url": "Download from site",
            "office_url": "Office submission",
            "api_available": False,
            "online_available": True,
        ...
        },
        {
            ...
            "name_change_url": None,
            "address_change_url": "https://www.vgl.co.in",
        ...
        },
        {
            ...
            "name_change_url": "https://www.irmenergy.com",
            "address_change_url": "https://www.irmenergy.com",
            "offline_form_url": "Office submission",
            "api_available": False,
            "online_available": False,
            "automation_type": "manual_only",
    ...
    "electricity": [
        {
            ...
            "address_change_url": "https://portal.guvnl.in",
            "offline_form_url": "Yes, at PGVCL office",
            "api_available": False,
            "online_available": True,
            "automation_type": "login_assisted",
        ...
        },
        {
            ...
            "name_change_url": "https://portal.guvnl.in/login.php",
            "address_change_url": "https://portal.guvnl.in",
            "offline_form_url": "Yes, at UGVCL office",
            "api_available": False,
            "online_available": True,
            "automation_type": "login_assisted",
        ...
        },
        {
            ...
            "name_change_url": "https://portal.guvnl.in/login.php",
            "address_change_url": "https://portal.guvnl.in",
            "offline_form_url": "Yes, at MGVCL office",
            "api_available": False,
            "online_available": True,
            "automation_type": "login_assisted",
        ...
        },
        {
            ...
            "name_change_url": "https://portal.guvnl.in/login.php",
            "address_change_url": "https://portal.guvnl.in",
            "offline_form_url": "Yes, at DGVCL office",
            "api_available": False,
            "online_available": True,
            "automation_type": "login_assisted",
    ...
    "water": [
        {
            ...
            "name_change_url": None,
            "address_change_url": "https://watersupply.gujarat.gov.in/other-info",
        ...
        },
        {
            ...
            "name_change_url": None,
            "address_change_url": None,
            "offline_form_url": "Yes, at AMC office",
            "api_available": False,
            "online_available": True,
            "automation_type": "login_assisted",
        ...
        },
        {
            ...
            "name_change_url": None,
            "address_change_url": None,
            "offline_form_url": "Yes, at SMC office",
            "api_available": False,
            "online_available": True,
            "automation_type": "login_assisted",
            "name_change_facility": "Yes (online initiation, manual approval)",
        ...
        },
        {
            ...
            "name_change_url": None,
            "address_change_url": None,
            "offline_form_url": "Yes, at VMC office",
            "api_available": False,
            "online_available": False,
            "automation_type": "manual_only",
        ...
        },
        {
            ...
            "name_change_url": None,
            "address_change_url": None,
            "offline_form_url": "Yes, at RMC office",
            "api_available": False,
            "online_available": False,
            "automation_type": "manual_only",
    ...
    "property": [
        ...
        {
            "id": "talati",
            "name": "Talati (Village Officer – Revenue Department)",
            "type": "government",
            "portal_url": "https://anyror.gujarat.gov.in",
            "name_change_url": "https://anyror.gujarat.gov.in",
            "address_change_url": "https://anyror.gujarat.gov.in",
            ...
            "online_available": False,
            "automation_type": "manual_only",
            "name_change_facility": "Yes (offline mutation process)",
            "address_change_facility": "Yes (offline correction process)"
        },
        {
            "id": "mamlatdar",
            "name": "Mamlatdar / Tehsildar (Taluka Revenue Office)",
            "type": "government",
            "portal_url": "https://revenuedepartment.gujarat.gov.in",
            "name_change_url": "https://revenuedepartment.gujarat.gov.in",
            "address_change_url": "https://revenuedepartment.gujarat.gov.in/application-forms",
            "offline_form_url": "https://revenuedepartment.gujarat.gov.in/e-dhara-forms",
            "api_available": False,
            "online_available": False,
            "automation_type": "manual_only",
            "name_change_facility": "Yes (final approval authority, manual)",
            "address_change_facility": "Yes (manual approval)"
        },
        {
            "id": "edhara-centers",
        ...
        },
        {
            ...
            "type": "private",
            "portal_url": "https://www.indiafilings.com",
            "name_change_url": "https://www.indiafilings.com/learn/gujarat-land-mutation/",
            "address_change_url": "https://www.indiafilings.com/learn/gujarat-land-mutation/",
            "offline_form_url": "https://revenuedepartment.gujarat.gov.in/e-dhara-forms",
            "api_available": False,
            "online_available": True,
            "automation_type": "assisted_service",
            "name_change_facility": "Yes (legal & documentation support only)",
            "address_change_facility": "Yes (documentation support)"
        },
        {
            "id": "ezylegal",
            "name": "ezyLegal (Private Legal & Property Services)",
            "type": "private",
            "portal_url": "https://www.ezylegal.in",
            "name_change_url": "https://ezylegal.in/property",
            "address_change_url": "https://ezylegal.in/property",
            "offline_form_url": "https://revenuedepartment.gujarat.gov.in/e-dhara-forms",
            "api_available": False,
            "online_available": True,
            "automation_type": "assisted_service",
            "name_change_facility": "Yes (legal facilitation, not direct mutation)",
            "address_change_facility": "Yes (legal facilitation)"
        },
        {
            "id": "local-agents",
            "name": "Local Property Tax & Mutation Agents",
            "type": "private",
            "portal_url": "https://www.justdial.com/Ahmedabad/Property-Mutation-Consultants",
            "name_change_url": "https://www.justdial.com/Ahmedabad/Property-Mutation-Consultants",
            "address_change_url": "https://www.justdial.com/Ahmedabad/Property-Mutation-Consultants",
            "offline_form_url": "https://revenuedepartment.gujarat.gov.in/application-forms",
            "api_available": False,
            "online_available": False,
            "automation_type": "manual_only",
            "name_change_facility": "Yes (offline assistance)",
            "address_change_facility": "Yes (offline assistance)"
        }
    ]
}
...
def update_services_data():
    ...
    try:
        ...
        with open(services_file, 'w', encoding='utf-8') as f:
            json.dump(COMPLETE_SUPPLIERS_DATA, f, indent=2, ensure_ascii=False)
        
        print("✅ Complete services data updated successfully!")
        print(f"📊 Updated suppliers:")
        for category, suppliers in COMPLETE_SUPPLIERS_DATA.items():
            print(f"   {category.upper()}: {len(suppliers)} suppliers")
            for supplier in suppliers:
                print(f"     • {supplier['name']}")
                if supplier.get('name_change_url'):
                    print(f"       Name Change: {supplier['name_change_url']}")
                if supplier.get('address_change_url'):
                    print(f"       Address Change: {supplier['address_change_url']}")
...
if __name__ == "__main__":
    print("🚀 Updating ALL Gujarat suppliers with correct official portal URLs...")
    ...
    if success:
        ...
        print("4. Each supplier will now redirect to their correct official website")
    else:
